...
public class AlongWithCountryFormatTwo implements Format {
    String data;
    String res="";
    LinkList list = new LinkList();
    String givenCountry;
    public AlongWithCountryFormatTwo(String data,String country){
        ...
        for (int i=0;i<list.length;i++){
            if(itr.currentNode.country.equals(givenCountry.toString())) {
                if (itr.currentNode.gender.equals("Female")) {
                    ...
                    res += "Mr";
                res += " " + itr.currentNode.lastName + "," + itr.currentNode.firstName + ","+itr.currentNode.country;
                if (itr.hasNext())
                    res+="\n";
            }
